...
\subsubsection{Requisitos funcionales}
	\begin{enumerate}
		...
		\item El plataforma pedirá los credenciales del usuario al comenzar.
		\item El plataforma se encargará de revisar la veracidad de los credenciales del usuario.
