...
\item Parte de DISEÑO: se empezará describiendo qué es una arquitectura de pizarra, qué componentes la forman, etc para posteriormente analizar los requisitos y los diagramas UML de los que constará nuestra aplicación y, finalmente, dar un manual con las operaciones básicas de nuestra aplicación. 
\end{itemize}
