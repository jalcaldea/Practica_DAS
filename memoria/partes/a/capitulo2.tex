...
Siguiendo un órden de menor a mayor nivel, comenzaremos con el \emph{hardware} para terminar con las distintas \emph{VMs}.
...
Cabe destacar que el hardware se comunica con el sistema operativo a traves de su \emph{kernel}. Pero esta últiima representación profundiza en términos que en estos momentos no nos son de utilidad, por lo que nos vamos a quedar con esta representación
a partir de ahora:
