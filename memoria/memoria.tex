...
\usepackage{rotating} % Para una mejor visualización en el pdf se puede usar \usepackage{pdflscape}
\usepackage[T1]{fontenc} % Necesario para que se vea el diagrama de casos de uso
\usepackage{lmodern} % Mejor renderizado al generar el pdf
...
\tableofcontents
\newpage{\ } %Añadida página para que no acabe y comience el prefacio
%\thispagestyle{empty}
